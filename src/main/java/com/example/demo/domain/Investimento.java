...
public class Investimento {
	...
	public int hashCode() {
		...
		result = prime * result + ((quantidadeCota == null) ? 0 : quantidadeCota.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (dataCompra == null) {
			...
			return false;
		if (quantidadeCota == null) {
			if (other.quantidadeCota != null)
				return false;
		} else if (!quantidadeCota.equals(other.quantidadeCota))
			return false;
		if (valorCota == null) {
